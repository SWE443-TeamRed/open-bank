...
public class S1_Login_Test {
    ...
    public void TinaLogsIntoHerBankingAccount(){
        ...
        storyboard.assertEquals("Tina is currently not logged in", false,checking.isLoggedIn());
        ...
        storyboard.assertEquals("Tina is now logged in", true, checking.isLoggedIn());
