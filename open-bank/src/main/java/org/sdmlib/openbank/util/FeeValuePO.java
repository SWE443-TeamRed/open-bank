...
public class FeeValuePO extends PatternObject<FeeValuePO, FeeValue>
{
   ...
   public FeeValuePO createPercentCondition(double value)
   {
      new AttributeConstraint()
   ...
   public FeeValuePO createPercentCondition(double lower, double upper)
   {
      new AttributeConstraint()
      .withAttrName(FeeValue.PROPERTY_PERCENT)
      .withTgtValue(lower)
   ...
   public FeeValuePO createPercentAssignment(double value)
   {
      new AttributeConstraint()
      .withAttrName(FeeValue.PROPERTY_PERCENT)
      .withTgtValue(value)
   ...
   public FeeValuePO withPercent(double value)
   {
      if (this.getPattern().getHasMatch())
      {
